from ..pathfinder.com_interface import Communication
import math
import numpy as np
from ..pathfinder.position import Position
...
class FakeRobot(Communication):
    ...
    def simulate(self, dt):
        # read the wheel velocity for motor
        self.motord.read_w_wheel(self.velocity[0])
        self.motorg.read_w_wheel(self.velocity[1])
